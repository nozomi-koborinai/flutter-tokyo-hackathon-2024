...
class PlayerIntro2 extends HookConsumerWidget {
  const PlayerIntro2({super.key, required this.uid, required this.room});
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image:
                                      NetworkImage(otherUser.characterImageUrl),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
